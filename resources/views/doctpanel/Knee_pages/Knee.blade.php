...
<form action="" id="myForm">
    <div>
        ...
        <div class="section">
            <div class="row">
                <div class="col" data-title="Chief Complaint">
                    ...
                    <div class="form-group">
                        ...
                        <div class="checkbox-group" data-group="first_occures_at" data-exclusive="true">
                            ...
                            <div class="checkbox-item">
                                <input type="checkbox" name="first_occures_at" value="" class="toggle-input"
                                    data-target="#input1">
                                <label for="">Other</label>
                            </div>
                            <input type="text" placeholder="Specify other location" name="First_occures_at_other"
                                class="inline-input" id="input1" disabled>
                        </div>
                ...
                <div class="col">
                    <div data-title="Symptom Evolution">
                        ...
                        <div data-group="Symptom_Evolution">
                            <div class="checkbox-group">
                                ...
                                <div class="checkbox-item">
                                    <input type="checkbox" id="mildly" name="symptom_evolution"
                                        value="Mildly_Progressive">
                            ...
                            <div class="checkbox-group">
                                <div class="checkbox-item">
                                    <input type="checkbox" id="moderately" name="symptom_evolution"
                                        value="Moderately_Progressive">
                                    <label for="moderately">Moderately Progressive</label>
                                </div>
                                <div class="checkbox-item">
                                    <input type="checkbox" id="severely" name="symptom_evolution"
                                        value="Severely_Progressive">
                        ...
                        <div class="form-group">
                            <div style=" margin-top: 10px;">
                                <div class="checkbox-group">
                                    <div class="checkbox-item">
                                        <input type="checkbox" id="improving" name="symptom_evolution"
                                            value="">
                                        <label for="improving">Improving (</label>
                                    </div>
                                    <div class="checkbox-group" style="margin-bottom:0;" data-group="improving1"
                                        data-exclusive="true">
                                        <div class="checkbox-item">
                                            <input type="checkbox" id="gradually" name="improving1"
                                                value="Gradually" disabled>
                                            <label for="gradually">Gradually</label>
                                        </div>
                                        <div class="checkbox-item">
                                            <input type="checkbox" id="quickly" name="improving1" value="Quickly"
                                                disabled>
                                            <label for="quickly">Quickly</label>
                                        </div>
                                        <div class="checkbox-item">
                                            <input type="checkbox" id="resolved" name="improving1" value="Resolved"
                                                disabled>
                    ...
                    <div class="mt-5" data-title="Presenting Symptoms">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="inline-input" placeholder="Describe Pain Score"
                                name="Pain_Score">
                        </div>
                        <div class="form-group">
        ...
        <div class="section">
            <div class="row">
                <div class="col" data-title="Past Knee History">
                    ...
                    <div class="checkbox-group" data-group="past_knee_history1" data-exclusive="true">
                        ...
                        <div class="checkbox-item">
                            <input type="checkbox" name="past_knee_history1" value="" class="toggle-input"
                                data-target="#input2">
                            <label for="">Previous injury/surgery:</label>
                        </div>
                    </div>
                    <textarea name="Previous_injury_surgery_value" id="input2" placeholder="Describe previous injury/surgery"
                        disabled></textarea>
                ...
                <div class="col" data-title="Aggravating Factors">
                    <div data-group="Aggravating_Factors">
                        ...
                        <div class="checkbox-group">
                            ...
                            <div class="checkbox-item">
                                <input type="checkbox" name="Aggravating_factors" value=""
                                    class="toggle-input" data-target="#input3">
                                <label for="">Others:</label>
                            </div>
                            <input type="text" placeholder="Specify other aggravating factors"
                                name="Aggravating_factors_others" id="input3" disabled>
                        </div>
                    </div>
                    <div class="subsection" data-group="Relieving_Factors">
                        ...
                        <div class="checkbox-group">
                            ...
                            <div class="checkbox-item">
                                <input type="checkbox" name="Relieving_factors" value="" class="toggle-input"
                                    data-target="#input4">
                                <label for="">Other:</label>
                            </div>
                            <input type="text" placeholder="Specify other relieving factors"
                                name="Relieving_factors_others" id="input4" disabled>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="section">
            <div class="row">
                <div class="col" data-title="Treatment History">
                    ...
                    <div class="subsection">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="inline-input" placeholder="Describe Type"
                                name="Injection_Details_type">
                            <label for="" class="label1">Date:</label>
                            <input type="text" class="inline-input" id="Injection_Details_display" readonly>
                            <!-- Hidden actual value -->
                            <input type="hidden" id="Injection_Details" name="Injection_Details_date"> <label
                                for="" class="label1">Location:</label>
                            <input type="text" placeholder="Describe Location" class="inline-input"
                                name="Injection_Details_location">
                        </div>
                    </div>
                ...
                <div class="col">
                    ...
                    <div data-group="Goal_of_Treatment" data-title="Goal of Treatment">
                        <div class="checkbox-group">
                            <div class="checkbox-item">
                        ...
                        <div class="checkbox-group">
                            ...
                            <div class="checkbox-item">
                                <input type="checkbox" name="goal_of_treatment" value="" class="toggle-input"
                                    data-target="#input5">
                                <label for="">Other:</label>
                    ...
                    <div class="mt-5" data-title="Review of Systems">
                    ...
                    <div class="mt-5" data-title="Past Medical History">
        ...
        <div class="section">
            <div class="row">
                <div class="col">
                    ...
                    <div class="mt-5" data-title="Family History">
                        ...
                        <div class="checkbox-group" data-group="family_history" data-exclusive="true">
                            ...
                            <div class="checkbox-item">
                                <input type="checkbox" name="family_history" value="" class="toggle-input"
                                    data-target="#input6">
                                <label for="">Relevant history:</label>
                            </div>
                            <textarea name="family_history_relevant_history_value" id="input6" placeholder="Describe Relevant History"
                                disabled></textarea>
                        </div>
                    </div>
                </div>
                <div class="col" data-title="Social History">
                    ...
                    <div class="subsection">
                        ...
                        <div class="checkbox-group" data-group="alcohol" data-exclusive="true">
                            ...
                            <div class="checkbox-item">
                                <input type="checkbox" name="alcohol" value="" class="toggle-input"
                                    data-target="#input7">
                                <label for="">Yes</label>
                            </div>
                            <div class="checkbox-item">
                                <input type="text" placeholder="Drinks/week" name="alcohol_value" id="input7"
                                    disabled>
                            </div>
                        </div>
                    </div>
                    <div class="subsection">
                        ...
                        <div class="checkbox-group" data-group="tobacco" data-exclusive="true">
                            ...
                            <div class="checkbox-item">
                                <input type="checkbox" name="tobacco" value="" class="toggle-input"
                                    data-target="#input8">
                                <label for="">Former:</label>
                            </div>
                            <input type="text" placeholder="Former quit Since" name="tobacco_value"
                                id="input8" disabled>
                        </div>
                    </div>
                </div>
        ...
        <div class="section">
            <div class="row">
                <div class="col text-center" data-title="Allergies & Medications">
                    ...
                    <div class="subsection">
                        ...
                        <div class="inline_row">
                            <label for="">1.</label>
                            <textarea name="Current_Medications_1" id=""></textarea>
                            <label for="">Dose:</label>
                            <textarea name="Current_Medications_1_dose" id=""></textarea>
                            <label for="">Freq:</label>
                            <textarea name="Current_Medications_1_freq" id=""></textarea>
                        </div>
                        <div class="pt-2 inline_row">
                            <label for="">2.</label>
                            <textarea name="Current_Medications_2" id=""></textarea>
                            <label for="">Dose:</label>
                            <textarea name="Current_Medications_2_dose" id=""></textarea>
                            <label for="">Freq:</label>
                            <textarea name="Current_Medications_2_freq" id=""></textarea>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div>
        ...
        <div class="section">
            <div class="row">
                <div class="col" data-title="Observation">
                    <h5>1.Observation</h5>
                ...
                <div class="col">
                    ...
                    <div class="mt-5" data-title="Palpation Findings">
                        ...
                        <div class="subsection">
                            ...
                            <div>
                                ...
                                <div class="flexdiv">
                                    <input type="checkbox" name="palpated_structure"
                                        value="Patella_facts,bursa,ligament">
                                ...
                                <div class="flexdiv">
                                    <input type="checkbox" name="palpated_structure"
                                        value="Medial_Joint_&_Meniscus">
                                    <label for="">Medial Joint & Meniscus</label>
                                </div>
                                <div class="flexdiv">
                                    <input type="checkbox" name="palpated_structure"
                                        value="Medial_Femoral_Condyle">
                                ...
                                <div class="flexdiv">
                                    <input type="checkbox" name="palpated_structure"
                                        value="Lateral_Joint_&_Meniscus">
                                    <label for="">Lateral Joint & Meniscus</label>
                                </div>
                                <div class="flexdiv">
                                    <input type="checkbox" name="palpated_structure"
                                        value="Lateral_Femoral_Condyle">
                                    <label for="">Lateral Femoral Condyle</label>
                                </div>
                                <div class="flexdiv">
                                    <input type="checkbox" name="palpated_structure"
                                        value="Lateral_Tibial_Condyle">
        ...
        <div class="section">
            <div class="row">
                <div class="col" data-title="Vascular Exam">
                ...
                <div class="col" data-title="Orthopedic Tests">
                    ...
                    <div>
                        ...
                        <div class="flexdiv1">
                            <input type="checkbox" name="Orthopedic_Tests"
                                value="External_rotation_recurvatum_test">
        ...
        <div class="section">
            <div class="row">
                <div class="col" data-title="Neurologic & Motor Exam">
                ...
                <div class="col" data-title="Additional Exams">
                    ...
                    <div class="subsection">
                        ...
                        <div class="form-group" data-group="Differential_Diagnosis">
                            <div class="checkbox-item">
                                <input type="checkbox" name="" class="toggle-input"
                                    data-target="#input9">
                                <label for="" class="label1">Clinical Impression:</label>
                            </div>
                            <textarea name="Clinical_Impression" id="input9" placeholder="Describe Clinical Impression" disabled></textarea>
                        </div>
                        <div class="form-group" data-group="plan">
                            ...
                            <textarea name="Plan" id="input10" placeholder="Describe Plan" disabled></textarea>
                        </div>
                        <div class="checkbox-group">
                            <div class="checkbox-item">
...
@php
    $currentRecord = \App\Models\Opdpart::select('data')
        ->where('type', 'knee')
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        populateForm(document.getElementById('myForm'), formDataFromDB);
    });

    $(function() {
        $("#Injection_Details_display").datepicker({
            dateFormat: "dd-mm-yy",
            altField: "#Injection_Details",
            altFormat: "yy-mm-dd"
        });
    ...
    // ✅ Checkbox & related input enabling/disabling logic
    ...
    // Improving checkbox extra logic
    ...
    function getFormDataAsJSON(formElement) {
        ...
        for (const [key, value] of formData.entries()) {
            ...
            // Get the input element (works for checkboxes and normal inputs)
            const inputEl = formElement.querySelector(`[name="${key}"][value="${value}"], [name="${key}"]`);

            // Skip checkbox with empty related input
            ...
            // Always try to get the group title from parent with data-title
            let title = null;
